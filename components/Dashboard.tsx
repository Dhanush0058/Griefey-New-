...
const StatCard = ({ title, value, color }: { title: string, value: number, color: string }) => (
    <div className={`p-4 rounded-lg shadow-md flex-1 text-center ${color}`}>
    ...
    <div className="max-w-4xl mx-auto">
       ...
       <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-4 text-white">
                <StatCard title={t('submitted')} value={stats.submitted || 0} color="bg-blue-500" />
                <StatCard title={t('inProgress')} value={stats.in_progress || 0} color="bg-purple-500" />
                <StatCard title={t('resolved')} value={stats.resolved || 0} color="bg-green-500" />
            </div>
        </div>
